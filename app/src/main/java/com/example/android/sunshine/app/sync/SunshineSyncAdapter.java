...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void sendWearData(int highTemp, int lowTemp) {
        Log.d("Wear Data", "Sending Wear Data");
        googleApiClient.connect();
        // Create a map request with a URI so it is unique
        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/current-weather");

        // PUT data
        putDataMapRequest.getDataMap().putInt("high-temp", highTemp);
        putDataMapRequest.getDataMap().putInt("low-temp", lowTemp);
        ...
        Wearable.DataApi.putDataItem(googleApiClient, putDataRequest).setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
            ...
            public void onResult(@NonNull DataApi.DataItemResult dataItemResult) {
                if (!dataItemResult.getStatus().isSuccess()) {
                    Log.d("Put Data Status", "Failed to submit temperature data");
                }
                else {
